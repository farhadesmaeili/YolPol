...
const message = Message.create({id: "message-2", senderType: "INTERNAL_USER", channel: "TELEGRAM", body: "Your quote is ready.", createdAt: new Date("2026-08-25T10:00:00.000Z")});
