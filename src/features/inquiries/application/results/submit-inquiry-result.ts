...
export type SubmitInquiryResult =
  | Readonly<{status: "accepted"; inquiry: AcceptedInquiryDto; conversationAccessToken: string}>
  | Readonly<{status: "accepted_with_notification_failures"; inquiry: AcceptedInquiryDto; conversationAccessToken: string; failedChannels: readonly NotificationChannel[]}>
