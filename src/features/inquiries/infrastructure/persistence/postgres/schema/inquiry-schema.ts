...
export const inquiries = pgTable("inquiries", {
  ...
  preferredContactMethod: varchar("preferred_contact_method", {length: 20}).notNull(),
  ...
  check("inquiries_preferred_contact_check", sql`${table.preferredContactMethod} in ('email','whatsapp','telegram','phone')`),
