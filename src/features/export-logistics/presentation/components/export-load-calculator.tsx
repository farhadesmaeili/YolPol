...
export function ExportLoadCalculator({products, labels, locale}: {products: readonly CalculatorProductOption[]; labels: Labels; locale: Locale}) {
  ...
  const number = {format: (value: number) => formatHumanNumber(locale, value)};
