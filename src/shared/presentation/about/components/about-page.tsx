...
type AboutModel = Readonly<{isRtl: boolean; breadcrumbLabel: string; homeLabel: string; eyebrow: string; heading: string; introduction: string; catalog: string; pricing: string; location: string; imageAlt: string; productsCta: string; contactCta: string}>;
