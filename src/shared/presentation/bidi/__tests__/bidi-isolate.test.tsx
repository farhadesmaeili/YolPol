...
describe("bidi presentation primitives", () => {
  ...
  it("preserves canonical contact and technical values", () => { expect(siteConfig.contact.phones.map(({href}) => href)).toEqual(["tel:+989121221942", "tel:+989123945674"]); expect(siteConfig.contact.whatsapp.href).toBe("https://wa.me/989123945674"); expect(renderToStaticMarkup(<LtrIsolate>YLP-GB-250-01</LtrIsolate>)).toContain("YLP-GB-250-01"); });
