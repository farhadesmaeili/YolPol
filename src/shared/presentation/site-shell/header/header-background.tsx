  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute start-1/2 top-[-8rem] h-64 w-[min(46rem,90vw)] -translate-x-1/2 rounded-full bg-white/28 blur-[95px]" />
      ...
      >
        <div className="absolute inset-0 animate-[spin_32s_linear_infinite] rounded-full border border-stone-950/[0.045] border-t-emerald-800/25 motion-reduce:animate-none">
          <span className="absolute start-1/2 top-[-3px] size-1.5 -translate-x-1/2 rounded-full bg-emerald-800/70" />
        </div>
