  ...
  return (
    <footer className="bg-footer text-footer-foreground">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 sm:px-8 md:grid-cols-2 lg:grid-cols-4">
        <section><h2 className="text-xl font-semibold">{siteConfig.name}</h2><p className="mt-4 max-w-sm text-sm leading-7 text-stone-300">{t("footer.description")}</p></section>
