export function FooterBackground() {
  return (
    <>
      ...
      <div aria-hidden="true" dir="ltr" className="pointer-events-none absolute bottom-[-3vw] start-1/2 z-0 max-w-full -translate-x-1/2 select-none overflow-hidden whitespace-nowrap text-[clamp(5rem,20vw,25rem)] font-black leading-none tracking-[-0.09em] text-stone-950/[0.025]">
        YOLPOL
      </div>
      ...
      <div aria-hidden="true" className="pointer-events-none absolute -end-28 top-12 z-[1] size-72 sm:-end-40 sm:size-[480px] lg:-end-[16rem] lg:size-[620px] lg:max-w-[55vw] xl:size-[760px]">
        <div className="absolute inset-0 animate-[spin_32s_linear_infinite] rounded-full border border-stone-950/[0.07] border-t-emerald-800/50 motion-reduce:animate-none">
          <span className="absolute start-1/2 top-[-5px] size-2.5 -translate-x-1/2 rounded-full bg-emerald-800 shadow-[0_0_26px_rgba(6,78,59,0.4)]" />
        ...
        <div className="absolute inset-[12%] animate-[spin_45s_linear_infinite] rounded-full border border-stone-950/[0.055] border-b-stone-950/25 [animation-direction:reverse] motion-reduce:animate-none">
          <span className="absolute bottom-[-4px] start-1/2 size-2 -translate-x-1/2 rounded-full bg-stone-800/60" />
        </div>
        ...
        <div className="absolute start-1/2 top-[8%] h-[84%] w-px -translate-x-1/2 bg-gradient-to-b from-transparent via-stone-950/[0.065] to-transparent" />
