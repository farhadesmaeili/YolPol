...
type ContactModel = Readonly<{isRtl: boolean; breadcrumbLabel: string; homeLabel: string; eyebrow: string; heading: string; introduction: string; email: string; phone: string; location: string; contactLocation: string; social: string; instagramLabel: string; telegramLabel: string; inquiryCta: string}>;
