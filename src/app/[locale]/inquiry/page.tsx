...
export default async function InquiryPage({params}: Props) {
  ...
  const chatLabels = {title:chat("title"),description:chat("description"),messages:chat("messages"),empty:chat("empty"),customerAuthor:chat("customerAuthor"),supportAuthor:chat("supportAuthor"),messageLabel:chat("messageLabel"),messagePlaceholder:chat("messagePlaceholder"),send:chat("send"),sending:chat("sending"),loading:chat("loading"),sent:chat("sent"),errorTitle:chat("errorTitle"),errors:{required:chat("errors.required"),tooLong:chat("errors.tooLong"),validation:chat("errors.validation"),rateLimited:chat("errors.rateLimited"),network:chat("errors.network"),service:chat("errors.service")}};
