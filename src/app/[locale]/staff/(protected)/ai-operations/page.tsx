...
export default async function AiOperationsPage({params}: AiOperationsPageProps) {
  ...
  return <AiOperationsControlPanel
    ...
    labels={{
      ...
      emergencyStop: {
        title: t("emergencyStop.title"), activeStatus: t("emergencyStop.activeStatus"), disabledStatus: t("emergencyStop.disabledStatus"), activeDescription: t("emergencyStop.activeDescription"), disabledDescription: t("emergencyStop.disabledDescription"), environmentDescription: t("emergencyStop.environmentDescription"), unconfiguredDescription: t("emergencyStop.unconfiguredDescription"),
        disable: t("emergencyStop.disable"), enable: t("emergencyStop.enable"), enableUnavailable: t("emergencyStop.enableUnavailable"), disabling: t("emergencyStop.disabling"), enabling: t("emergencyStop.enabling"), disabled: t("emergencyStop.disabled"), enabled: t("emergencyStop.enabled"), readOnly: t("emergencyStop.readOnly"), confirmTitle: t("emergencyStop.confirmTitle"), confirmDescription: t("emergencyStop.confirmDescription"), cancel: t("emergencyStop.cancel"), confirmDisable: t("emergencyStop.confirmDisable"),
        errors: {invalid: t("errors.invalid"), conflict: t("errors.conflict"), forbidden: t("errors.forbidden"), rate_limited: t("errors.rate_limited"), failed: t("errors.failed")},
      },
