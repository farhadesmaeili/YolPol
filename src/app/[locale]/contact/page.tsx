...
export default async function ContactPage({params}: Props) {
  ...
  return (
    <><ContactPagePresentation model={{isRtl: locale === "fa" || locale === "ar", breadcrumbLabel: breadcrumbs("label"), homeLabel: breadcrumbs("home"), eyebrow: t("eyebrow"), heading: t("heading"), introduction: t("introduction"), email: t("email"), phone: t("phone"), location: t("location"), contactLocation: siteConfig.contact.location.officeAddress[locale], social: t("social"), instagramLabel: t("instagramLabel"), telegramLabel: t("telegramLabel"), inquiryCta: inquiry("heading")}} />
